...
@section('title',$cat? $cat->name : 'World Pedia')
@section('section')
    <div class="page-breadcrumbs">
        <h1 class="section-title">{{$cat ? $cat->name :''}}</h1>
    </div>
    <div class="section">
        <div class="row">
                        ...
                        <div class="google-add">
                            <div class="add inner-add text-center">
                                <a href="#"><img class="img-fluid"
                                                 src="{{URL::to('frontend/images/post/add/grafiasflat.gif')}}" alt="Image"/></a>
                            </div><!--/.section-->
                        </div><!--/.google-add-->
                    </div>
                </div>
                            ...
                            @foreach($popularPosts as $p)
                                <li>
                                    <div class="post small-post">
                                        ...
                                        <div class="post-content">
                                            {{--                                            <div class="video-catagory"><a href="#">{{$p->c_name}}</a></div>--}}
                                            <h2 class="entry-title">
                                                <a href="{{route('details',['slug'=>$p->slug])}}">{{$p->title}}</a>
                                            </h2>
                                        </div>
